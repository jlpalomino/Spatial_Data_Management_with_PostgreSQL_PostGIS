...
/* */
INSERT INTO employees (uid, firstname, lastname, department) VALUES (6, 'Jenny', 'Palomino', 'Education');
...
/* */
select * from employees;
UPDATE employees SET officeloc = '103 Mulford' WHERE department = 'Public Health';
UPDATE employees SET officeloc = '132 Mulford' WHERE department = 'Financial';
UPDATE employees SET officeloc = '111 Mulford' WHERE department = 'Transportation';
...
/* */
SELECT officeloc, count(*) FROM employees group by officeloc order by officeloc;
...
/* */
SELECT distinct(county) from lymedisease order by county;
SELECT * from lymedisease where county = 'Alameda';
...
/* */
SELECT * from lymedisease order by y2005 DESC;
...
/* */
UPDATE lymedisease SET y2005label = 'YES' where y2005 > 0;
UPDATE lymedisease SET y2005label = 'NO' where y2005 = 0;

select * from lymedisease order by y2005label;
